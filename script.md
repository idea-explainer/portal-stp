...
- **Interactive:** slider for applied force on a 500 kg mass (F = 0 to 200 N) — The force arrow lengthens, the block accelerates visibly, and the velocity-time line steepens; at F = 0 the block coasts at constant velocity.
- **Quantitative anchor:** 100 N on 500 kg gives a = 0.2 m/s² — about 12 m/s of velocity gained per minute of thrusting.
- **Physics checks:**
...
## Scene 2 — In space, you move by throwing mass
...
- **Interactive:** slider for speed at which the 1 kg wrench is thrown (v = 1 to 20 m/s) — The wrench flies away faster, the astronaut's recoil-velocity readout rises in proportion (v/100), and the two momentum arrows stay equal and opposite.
- **Quantitative anchor:** A 1 kg wrench thrown at 10 m/s gives a 100 kg astronaut a recoil of exactly 0.1 m/s.
- **Physics checks:**
...
## Scene 3 — Temperature is molecular speed
...
- **Builds on:** nothing — foundational
- **Caption:** What is temperature, really? If you could look into a gas closely enough you would see the molecules flying about, and temperature is just how energetically they fly: each molecule carries on average kinetic energy (3/2)kT, so the typical speed is √(3kT/M). Notice there are only two ways to make the molecules go faster — make the gas hotter, or make the molecules lighter. The nitrogen in this room is already doing about 500 m/s; hydrogen at 3,000 K does better than 6,000. Keep those two knobs in mind, because they are the entire secret of the thermal rocket.
- **Interactive:** slider for gas temperature (with molecule selectable) (T = 300 to 3,000 K; molecule buttons: H₂ / NH₃ / N₂) — The dots speed up as T rises and the speed readout climbs as √T; switching to a lighter molecule at fixed T makes the dots and the readout jump faster.
- **Quantitative anchor:** N₂ at 300 K: typical speed ~500 m/s; H₂ at 3,000 K: ~6,100 m/s.
- **Physics checks:**
...
## Scene 4 — Every maneuver spends from a fixed delta-v budget
...
## Scene 5 — Climbing to a higher orbit takes two forward burns
...
- **Builds on:** f-equals-ma, dv-budget
...
- **Interactive:** buttons for burn sequence (each burn fired prograde) (Burn 1: +2.4 km/s at LEO / Burn 2: +1.5 km/s at apogee / reset) — Burn 1 stretches the circular orbit into an ellipse touching GEO altitude; during the coast the speed readout falls from 10.1 to 1.6 km/s as the satellite climbs; Burn 2 rounds the ellipse into the GEO circle with the final speed reading 3.1 km/s — slower than the 7.7 km/s start — while total delta-v spent reads 3.9 km/s.
- **Quantitative anchor:** LEO 7.7 km/s → burn 1 +2.4 km/s → coast slows to 1.6 km/s at GEO altitude → burn 2 +1.5 km/s → 3.1 km/s circular. Total Δv ≈ 3.9 km/s.
- **Physics checks:**
...
## Scene 6 — Specific impulse: the momentum a kilogram of propellant buys
...
- **Builds on:** momentum-recoil
- **Caption:** Every rocket is in the business of buying momentum with mass, so let us ask the natural question: how much momentum do you get for each kilogram you throw away? The answer is simply the exhaust velocity — a kilogram thrown out at v_e carries v_e of momentum, no more and no less. Engineers, by an old convention, divide by g_0 and quote it in seconds: I_sp = v_e/g_0. A typical chemical thruster leaves the nozzle near 2.2 km/s (I_sp about 220 s), and even an exceptionally good one only reaches ~2.9 km/s (300 s); an ion thruster — the workhorse type is called a Hall thruster — hurls its atoms at some 15 km/s (I_sp about 1,500 s) — roughly seven times the momentum of a typical chemical thruster for every kilogram spent.
- **Interactive:** slider for exhaust velocity v_e (v_e = 1.8 to 15 km/s) — Pellets fly out faster, the Isp readout rises proportionally, and the grams-per-second needed for 1 N of thrust falls.
- **Quantitative anchor:** v_e ≈ 15 km/s corresponds to Isp ≈ 1,500 s (Hall thruster); v_e ≈ 2.2 km/s corresponds to Isp ≈ 220 s (typical chemical thruster); 300 s is near the best a storable chemical thruster achieves.
- **Physics checks:**
...
## Scene 7 — Propellant needs grow exponentially with delta-v
...
- **Builds on:** dv-budget, isp-is-exhaust-velocity
- **Caption:** Now watch what happens when we add up the recoil over a whole burn. The propellant you burn late had to be carried — and accelerated — by the propellant you burned early, and propellant pushing propellant compounds exactly like interest. The sum is Tsiolkovsky's equation, Δv = I_sp·g_0·ln(m_wet/m_dry), and turned around it says the propellant mass grows exponentially with the mission-required delta-v — the total velocity change you plan to execute. That exponential is merciless: a 500 kg spacecraft on chemical propellant — I_sp 300 s at its very best, closer to 220 s for a typical thruster — cannot tank its way past about 700 m/s no matter how it tries. The only escape is to raise the exhaust velocity, which shrinks the exponent — and that is why I_sp is worth real money.
- **Interactive:** slider for mission-required delta-v (with Isp selectable) (Δv = 0 to 6,000 m/s; Isp buttons: 220 s typical chemical / 300 s best chemical / 1,500 s electric) — The cursor climbs the propellant curve; the propellant-mass readout grows faster and faster; switching Isp buttons visibly flattens or steepens the entire curve.
- **Quantitative anchor:** At Isp = 300 s, a 500 kg-class spacecraft on storable chemical propellant exhausts its practical delta-v budget near 700 m/s.
- **Physics checks:**
...
## Scene 8 — Thrust decides how long a maneuver takes
...
- **Interactive:** slider for engine thrust (F = 1 mN to 200 N (log scale); Δv buttons: 100 m/s / 5,000 m/s) — The cursor slides along a straight slope-−1 line on the log-log plot and the clock readout shrinks from months to minutes as thrust rises.
- **Quantitative anchor:** For 500 kg and Δv = 100 m/s: ~10 minutes at ~100 N versus ~220 hours at millinewton ion-engine thrust.
- **Physics checks:**
...
## Scene 9 — For 50 years: strong thrust or high efficiency, never both
...
_Now the paper's machine. Focus sunlight with a mirror, heat a light gas, and both halves of the old tradeoff give way at once._

## Scene 10 — Sunlight heating a light gas beats combustion on efficiency
...
- **Builds on:** temperature-is-speed, isp-is-exhaust-velocity, thrust-isp-plane
- **Caption:** Here is where our two knobs come back. In a thermal rocket the exhaust speed is fixed by heat alone, v_e ∝ √(T/M) — and combustion, you notice, turns both knobs at once and tangles them: it makes the gas hot, but it insists on heavy product molecules. Suppose instead we heat the gas with concentrated sunlight. Then we may choose whatever molecule we please and run the temperature to the limit of the materials: ammonia, M = 17, at 3,000 K gives I_sp around 350–450 s — above anything a storable chemical rocket can reach — and hydrogen, M = 2, gives about 800 s. There is no flame anywhere; the mirror is the whole energy supply.
- **Interactive:** slider for chamber temperature (with propellant molecule selectable) (T = 1,000 to 3,000 K; molecule buttons: H₂ / NH₃ / combustion products (M ≈ 22 g/mol)) — The exhaust arrow lengthens and the Isp readout climbs as T rises; switching to a lighter molecule at fixed T jumps the Isp readout upward, crossing the 330 s ceiling line.
- **Quantitative anchor:** At ~3,000 K: ammonia Isp ≈ 350–450 s; hydrogen Isp ≈ 800 s.
- **Physics checks:**
...
## Scene 11 — And the mirror delivers chemical-class thrust
...
- **Builds on:** thrust-sets-time, sunlight-isp
...
- **Interactive:** slider for concentrated thermal power delivered to the propellant (P = 10 to 500 kW) — The solar-thermal thrust bar grows linearly with power, entering the 100–200 N chemical-class band around 200–400 kW while the Hall bar stays frozen near 0.05 N.
- **Quantitative anchor:** Solar-thermal thrust ~100–200 N — approximately 5 orders of magnitude above millinewton Hall-thruster thrust; membrane reflectors deliver >1,000 W/kg versus ~100 W/kg for solar arrays.
- **Physics checks:**
...
_A new engine only matters if it wins against what already flies. Here it is priced head-to-head against chemical and electric propulsion on cost, speed, and readiness._

## Scene 12 — What a maneuver costs with each engine type

- **Teaches:** Decoupling the energy source from the reaction mass removes the dominant recurring costs from each maneuver.
- **Builds on:** rocket-equation, sunlight-thrust
...
- **Interactive:** buttons for propulsion architecture (storable biprop / Hall electric / solar thermal) — The energy-flow arrows re-route (onboard bonds vs panels vs mirror) and the stacked cost bar re-composes: biprop's bar is dominated by hardware amortization, Hall's by xenon plus thruster wear, solar thermal's by a thin ammonia sliver plus widely amortized hardware.
- **Quantitative anchor:** At 100 m/s: storable biprop ≈ $1.46M per maneuver; solar thermal ≈ $222k; Hall electric ≈ $216k. Ammonia $1/kg versus xenon $2,500/kg.
- **Physics checks:**
...
## Scene 13 — Solar thermal is the cheapest at nearly every delta-v
...
- **Builds on:** rocket-equation, free-energy-cost
- **Caption:** Sweep the delta-v from a small debris dodge to a grand transfer and price each engine as you go. The rocket equation bends every cost curve upward — but it bends hardest on the low-I_sp chemical rocket, which quits altogether at its 700 m/s tank wall. The electric thruster keeps pace with solar thermal at 100 m/s, both near $220k a maneuver; but by 5,000 m/s the xenon and the worn grids have pushed it to $10.9M against solar thermal's $9.1M. Across the whole range, the mirror-and-ammonia machine holds the floor.
- **Interactive:** slider for delta-v of the maneuver being priced (Δv = 100 to 5,000 m/s) — The cursor sweeps right; readouts update; past 700 m/s the biprop readout switches to 'infeasible', and past ~3,000 m/s the green curve visibly undercuts the blue curve.
- **Quantitative anchor:** At 100 m/s: solar thermal $222k, biprop $1.46M, electric $216k. At 700 m/s: solar thermal ~$1.39M as biprop terminates. At 5,000 m/s: solar thermal $9.1M vs electric $10.9M.
- **Physics checks:**
...
## Scene 14 — Solar thermal is also the fastest: 9 hours vs 527 days
...
- **Builds on:** thrust-sets-time, sunlight-thrust
...
- **Interactive:** slider for delta-v of the maneuver being timed (Δv = 100 to 5,000 m/s) — The cursor sweeps right; the green clock climbs from ~10 minutes to ~9 hours while the blue clock climbs from ~223 hours to ~527 days, and the ratio readout stays above 1,000×.
- **Quantitative anchor:** Solar thermal: ~10 min at 100 m/s, ~9 h at 5,000 m/s. Electric: ~223 h at 100 m/s, >12,600 h (527 days) at 5,000 m/s.
- **Physics checks:**
...
## Scene 15 — Ammonia can wait in orbit; cryogenic fuels cannot
...
- **Builds on:** time-curves
- **Caption:** You might ask: why not simply fly a big cryogenic stage — methane and oxygen — and have strong thrust with better I_sp? Thermodynamics forbids it, in a sneaky way. Cryogens must be kept tens of degrees colder than anything sitting in sunlight can stay, so without refrigeration they boil away within hours — the tank empties before a waiting spacecraft ever gets to use it. That is why only launch rockets use cryogenics: their whole job is over in the first few hours. Ammonia sits happily at ordinary spacecraft temperatures for years. So the solar-thermal vehicle loiters for months and fires within minutes of the command — and being quick is worth nothing unless you are also ready.
- **Interactive:** slider for days of fueled loiter on orbit before a maneuver is commanded (t = 0 to 180 days) — The methalox fill level drops steadily and reaches near-empty within the days-scale portion of the slider; the ammonia level is unchanged at 180 days; the methalox response-time readout flips from hours to '≥24 h re-fuel latency'.
- **Quantitative anchor:** Cryogenic propellant boils off within hours without active cooling — only launch rockets, whose job ends within hours, can use it; methalox missions carry a minimum ~24-hour launch-and-fueling latency. Ammonia is storable indefinitely.
- **Physics checks:**
...
_The physics was proven decades ago. Three manufacturing advances made it buildable — just as orbit is about to get eighty times more crowded, with a nuclear version waiting behind it._

## Scene 16 — Blocked by manufacturing then, buildable now
...
- **Builds on:** sunlight-isp
- **Caption:** If the idea is so good, why wasn't it flown forty years ago? The physics was demonstrated — a Rockwell study in 1979, hydrogen ground tests above 800 s of I_sp — but three pieces could not be built. The heat exchanger needed hundreds of brazed parts; it is now printed as a single piece. The old alloys gave up near 1,800 K; today's refractory alloys hold 3,000 K, and since v_e goes as √(T), that jump alone is worth about 29% more I_sp. And membrane mirrors, at better than 1,000 W/kg, finally made the collector light enough. All three arrived together — any one missing, and the machine stays on the shelf.
- **Interactive:** slider for heat-exchanger material temperature limit (T_limit = 1,800 to 3,000 K) — Both Isp readouts rise as √T (ammonia climbing from ~325 s toward ~420 s, hydrogen from ~620 s toward ~800 s), and the construction callout switches from brazed assembly to monolithic print.
- **Quantitative anchor:** 1980s ground tests demonstrated >800 s Isp with hydrogen; modern refractory alloys hold ~3,000 K versus a ~1,800 K 1980s cap; membrane reflectors deliver >1,000 W/kg versus ~100 W/kg arrays.
- **Physics checks:**
...
## Scene 17 — 80× more satellites means far more than 80× more dodging
...
- **Builds on:** dv-budget, time-curves
...
- **Interactive:** slider for orbital satellite population (N = 15,000 (today) to 1.2 million (filed)) — Dot density in the shell thickens dramatically; the conjunction-rate multiplier readout climbs quadratically, reaching ~6,400× at the slider maximum.
- **Quantitative anchor:** ~15,000 active satellites today versus >1.2 million in filings — an ~80× increase; pairwise conjunction rate at 80× population is ~6,400× today's.
- **Physics checks:**
...
## Scene 18 — The same engine can later run on nuclear heat
...
- **Builds on:** sunlight-thrust, why-now
...
- **Interactive:** toggle for heat source feeding the heat exchanger (concentrated sunlight ↔ fission reactor) — Only the heat-source block and its input arrow swap; the heat exchanger, channels, propellant path, and nozzle are pixel-identical, and the performance/cost dials update to ~90% / ~10% in the solar state.
- **Quantitative anchor:** Solar thermal ≈ 90% of nuclear-thermal performance at ≈ 10% of the cost; both operate the heat exchanger near ~3,000 K.
- **Physics checks:**
